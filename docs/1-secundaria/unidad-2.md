...
> <i class="bi bi-calendar"></i> **Fecha límite:** Domingo 04 de Mayo<br><i class="bi bi-laptop"></i> **Programa:** Microsoft Word<br>

Ve a la carpeta del curso y descarga el archivo de Mitos y leyendas. Aplica los estilos mostrados a continuación y envía tu proyecto en PDF a través del enlace que se encuentra al final de esta sección.
...
* **Texto Principal (Cuerpo):**
    * Fuente: Serif (Recomendadas: Garamond, Georgia, Cambria)
    * Tamaño: `11pt` o `12pt`
* **Títulos de Mitos/Leyendas:**
    * Fuente: Misma que cuerpo (en **Negrita**) o Sans Serif complementaria (Ej: Calibri, Arial)
    * Tamaño: `16pt` a `18pt`
    * Estilo: **Negrita**
* **Subtítulos (Ej: "Origen"):**
    * Fuente: Misma que cuerpo
    * Tamaño: `12pt` o `13pt` (1pt más grande que el cuerpo)
    * Estilo: **Negrita** o *Cursiva* (mantener consistencia)
* **Título Principal (Portada/Inicio):**
    * Fuente: Similar a títulos de leyendas
    * Tamaño: `22pt` a `28pt`
    * Estilo: **Negrita**

#### Formato de Párrafo (Texto Principal)
* **Alineación:** Izquierda
* **Interlineado:** `1.15` o `1.5` líneas.
* **Espaciado entre párrafos:** `6pt` u `8pt` *después* de cada párrafo (no usar dobles Enter).
* **Sangría:** Primera línea de `1 cm` o `1.25 cm` (excepto en párrafos que siguen a un título).

#### Estructura y Títulos
* **Niveles de Título:** Usar estilos consistentes para jerarquizar:
    * Nivel 1: Título principal del documento.
    * Nivel 2: Títulos de cada mito/leyenda.
    * Nivel 3 (o estilo específico): Subtítulo "Origen".
* **Espaciado Vertical:** Añadir espacio *antes* y *después* de los títulos (Nivel 2 y 3) para una clara separación visual.

#### Encabezados y Pies de Página
* **Encabezado:** Opcional. Puede incluir el título del documento ("Mitos y Leyendas Peruanas") o estar vacío. Considerar opción de "Páginas pares e impares diferentes".
* **Pie de Página:**
    * **Contenido Esencial:** Número de página (posición: centrado o borde exterior).
* **Opciones:** Activar "Primera página diferente" para que la portada o inicio no lleven encabezado/pie.

#### Tabla de Contenido
* **Inclusión:** Altamente recomendada al principio del documento (después de la portada).
* **Generación:** Basada en los estilos de título aplicados (Nivel 2).

#### Portada
* **Inclusión:** Recomendada como primera página.
* **Contenido:** Título principal, subtítulo (opcional), compilador (opcional), imagen (opcional).
* **Formato Específico:** Sin encabezado ni pie de página.

---

https://mariareinista-my.sharepoint.com/:f:/g/personal/admin_mrc_edu_pe/Eq0fCYKmft5PrGPIelUZ-1QBEcIcMrOWgpF-QKwxbT3l6g